    ...
    <?php include 'inc/sidebar.php'; ?>
        ...
        <div class="grid_10">
            ...
            $fb    = mysqli_real_escape_string($db->link, $fm->velidation($_POST['fb']));
            $tw    = mysqli_real_escape_string($db->link, $fm->velidation($_POST['tw']));
            $ln    = mysqli_real_escape_string($db->link, $fm->velidation($_POST['ln']));
            $gp    = mysqli_real_escape_string($db->link, $fm->velidation($_POST['gp']));
