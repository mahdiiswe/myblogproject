...
?>
        ...
        <div class="grid_10">
            ...
            $cat    = mysqli_real_escape_string($db->link, $fm->velidation($_POST['cat']));
            $body   = mysqli_real_escape_string($db->link, $fm->velidation(strip_tags($_POST['body'])));
            $tags   = mysqli_real_escape_string($db->link, $fm->velidation($_POST['tags']));
            $author = mysqli_real_escape_string($db->link, $fm->velidation($_POST['author']));
            $userid = mysqli_real_escape_string($db->link, $fm->velidation($_POST['userid']));
            ...
            ?>
                ...
                <?php 
                        ...
                        $query = "select * from tbl_post where id='$getpostid' order by id desc";
